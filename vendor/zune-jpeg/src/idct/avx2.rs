...
pub unsafe fn idct_avx2(
    ...
    macro_rules! dct_pass {
        ($SCALE_BITS:tt,$scale:tt) => {
            ...
            // even part
            let p1 = (row2 + row6) * 4433;

            let mut t2 = p1 + row6 * -15137;
            let mut t3 = p1 + row2 * 6270;

            let mut t0 = YmmRegister {
                mm256: _mm256_slli_epi32((row0 + row4).mm256, 13),
            };
...
pub unsafe fn idct_avx2_4x4(
    ...
    {
        row0.mm256 = _mm256_slli_epi32(row0.mm256, 13);
        row0 += 1024;
        ...
        row0.mm256 = _mm256_srai_epi32((x0 + t3).mm256, 11);
        row1.mm256 = _mm256_srai_epi32((x1 + t2).mm256, 11);
        row2.mm256 = _mm256_srai_epi32((x2 + t1).mm256, 11);
        row3.mm256 = _mm256_srai_epi32((x3 + t0).mm256, 11);

        row4.mm256 = _mm256_srai_epi32((x3 - t0).mm256, 11);
        row5.mm256 = _mm256_srai_epi32((x2 - t1).mm256, 11);
        row6.mm256 = _mm256_srai_epi32((x1 - t2).mm256, 11);
        row7.mm256 = _mm256_srai_epi32((x0 - t3).mm256, 11);
    }
...

    {
        ...
        row0.mm256 = _mm256_slli_epi32(i0.mm256, 13);
        ...
        row0.mm256 = _mm256_srai_epi32((x0 + t3).mm256, 18);
        row1.mm256 = _mm256_srai_epi32((x1 + t2).mm256, 18);
        row2.mm256 = _mm256_srai_epi32((x2 + t1).mm256, 18);
        row3.mm256 = _mm256_srai_epi32((x3 + t0).mm256, 18);
        row4.mm256 = _mm256_srai_epi32((x3 - t0).mm256, 18);
        row5.mm256 = _mm256_srai_epi32((x2 - t1).mm256, 18);
        row6.mm256 = _mm256_srai_epi32((x1 - t2).mm256, 18);
        row7.mm256 = _mm256_srai_epi32((x0 - t3).mm256, 18);
    }
