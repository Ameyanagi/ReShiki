...
**Publication**, **Presentation**, and **Pastel** control atom colors independently of the journal preset and light/dark canvas. Presentation uses muted conventional element colors; Pastel uses softer hues. Ring interiors use a separate palette adapted to each canvas, and automatic atom labels stay legible over dark fills.
