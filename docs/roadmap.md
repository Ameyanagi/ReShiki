...
6. **Native chemistry:** extend the Rust engine while preserving independent RDKit comparisons. Released apps use Rust chemistry and the bundled official InChI kernel; Python and uv remain optional development tools. Add differential fixtures before expanding supported chemistry.
