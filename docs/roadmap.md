...
5. **Publication and analysis:** build on physical page layouts and multipage PDF with journal styles, configurable export styles, native printing, calculated properties and spectra integration. Chemical naming and NMR prediction need dedicated engines and separate correctness/licensing evaluation; RDKit alone does not deliver the whole scope.
