...
- Templates keep placing by default: click successive atoms or bonds to build connected or fused structures. Escape finishes placement; each copy has its own Undo step.
