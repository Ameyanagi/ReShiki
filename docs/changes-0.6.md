...
- Installers and portable packages include everything needed for offline drawing and chemistry.

Downloads support Apple Silicon macOS, Windows x64/ARM64 and Linux x64/ARM64. Existing `.reshiki` drawings remain compatible. The assistant still requires a Codex connection.
