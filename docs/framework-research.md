...
Basic XML drawing exchange follows the public [CDX/CDXML format documentation](https://iupac.github.io/IUPAC-FAIRSpec/cdx_sdk/). Moruno's own document remains the source of truth because an interchange format may carry more objects and semantics than the current editor can represent.
