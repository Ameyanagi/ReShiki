...
Rust sanitizer building blocks now include functional-group charge normalization, radical assignment, default aromaticity perception and hydrogen restoration. Independent tests compare complete graphs, including fused rings, macrocycles, exocyclic bonds and atom permutations. These passes are not yet enabled in the application: production sanitization stays in RDKit until Kekulé assignment, metal normalization and stereochemistry are ready.
