...
ReShiki includes its native chemistry tools. No Python, RDKit, or uv installation is needed, and the app does not download a chemistry environment on first launch.
