...
- Import PNG, JPEG, TIFF or WebP through **Import → Picture…**. Resize, rotate, replace and layer embedded pictures with your drawing; macOS also supports picture paste. See [pictures](docs/pictures.md).
