...
//!
//! RDKit's macOS ARM64 wheel uses `__sincos_stret`; separate libc sin/cos calls
//! can return different bits. The workspace compiles this crate at opt-level 1
//! in development and tests, without optimizing the application as a whole.
